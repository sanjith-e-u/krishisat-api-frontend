    ...
    <div className="w-full max-w-[420px] bg-white border border-slate-200 rounded-2xl shadow-xl p-8 flex flex-col gap-6">
      ...
      {success ? (
        ...
        <div className="flex flex-col gap-5 text-center">
          <div className="p-4 bg-[#22C55E]/10 border border-[#22C55E]/20 text-[#14532D] rounded-xl flex flex-col items-center gap-2">
            ...
            <p className="text-xs leading-relaxed text-slate-650">
              If an account exists for <strong className="font-semibold text-slate-800">{email}</strong>, a reset email has been sent.
            </p>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-10 bg-[#14532D] hover:bg-[#114524] disabled:bg-[#14532D]/70 text-white text-sm font-semibold rounded-lg transition-colors flex items-center justify-center shadow-sm gap-2"
          >
            {loading ? (
