...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto mt-8 pb-20 px-6 font-sans">
      ...
      <h1 className="text-3xl font-extrabold text-foreground mt-4 tracking-tight">Terms of Service</h1>
      ...
      <div className="mt-8 prose prose-slate max-w-none text-slate-650 text-sm leading-relaxed space-y-6">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-foreground">2. Service Usage & Credit Quotas</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-foreground">3. Spatial Coordinates & Boundaries</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-foreground">4. Restrictions on Use</h2>
          <p>
