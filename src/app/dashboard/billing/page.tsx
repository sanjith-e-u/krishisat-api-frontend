...
import { CreditCard, Check, Download, ArrowUpRight, Lock, Sparkles, X } from "lucide-react"
...
const initialInvoices: InvoiceItem[] = [
  { id: "INV-2026-003", date: "Jun 10, 2026", amount: "₹999.00", status: "Paid" },
  { id: "INV-2026-002", date: "May 10, 2026", amount: "₹999.00", status: "Paid" },
  { id: "INV-2026-001", date: "Apr 10, 2026", amount: "₹999.00", status: "Paid" }
]

export default function DashboardBilling() {
  const [plan, setPlan] = useState<"Developer" | "Professional" | "Enterprise">("Developer")
  const [modalOpen, setModalOpen] = useState(false)
  const [selectedPlanTier, setSelectedPlanTier] = useState<"Developer" | "Professional" | "Enterprise">("Developer")
  ...
  const handleUpgrade = (tier: "Developer" | "Professional" | "Enterprise") => {
    setPlan(tier)
  ...
  const planCredits = {
    Developer: { limit: 10000, remaining: 9850, price: "₹999/mo" },
    Professional: { limit: 60000, remaining: 59850, price: "₹4,999/mo" },
    Enterprise: { limit: 500000, remaining: 498500, price: "Custom" }
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
            ...
            <div>
              ...
              <div className="mt-6">
                <div className="flex justify-between text-xs font-semibold text-slate-600 mb-2">
                  ...
                  <span>{currentPlanDetails.remaining.toLocaleString()} of {currentPlanDetails.limit.toLocaleString()} credits left</span>
                </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm flex flex-col justify-between">
            <div>
              ...
              <div className="mt-5 space-y-1 text-xs text-slate-500 leading-normal">
            ...
            <div className="pt-6 border-t border-slate-100 mt-6 flex gap-3">
              <button
                ...
                className="flex-1 h-9 border border-slate-200 hover:bg-slate-50 text-slate-600 rounded-lg text-xs font-bold transition-all focus:outline-none"
              >
                Update Details
              </button>
            </div>
                  ...
                  <tr key={inv.id} className="hover:bg-slate-50/40 transition-colors">
                    ...
                    <td className="py-4 px-6 text-right">
                      <button
                        ...
                        className="p-1.5 border border-slate-200 text-slate-500 hover:text-slate-900 bg-white hover:bg-slate-50 rounded-lg transition-colors focus:outline-none inline-flex items-center gap-1.5 text-xs font-semibold shadow-sm"
                      >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
            ...
            <div className="relative bg-white border border-slate-200 rounded-2xl shadow-2xl w-full max-w-[850px] z-50 animate-in slide-in-from-top-4 duration-300 flex flex-col max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* Plan: Sandbox / Developer Tier */}
                <div
                  onClick={() => setSelectedPlanTier("Developer")}
                  className={cn(
                    "border rounded-xl p-5 flex flex-col justify-between cursor-pointer transition-all relative",
                    selectedPlanTier === "Developer"
                ...
                >
                  ...
                  <div>
                    <h4 className="text-sm font-extrabold text-slate-900">Developer</h4>
                  ...
                  <button
                    ...
                    disabled={plan === "Developer"}
                  >
                    {plan === "Developer" ? "Current Plan" : "Choose Plan"}
                  </button>
                </div>
                ...
                >
                  ...
                  <div>
                    <div className="flex items-center gap-1.5">
                      <h4 className="text-sm font-extrabold text-slate-900">Professional</h4>
                    ...
                    <p className="text-[10px] text-slate-400 leading-relaxed mt-1">For production-ready agricultural dashboards.</p>
                    ...
                    <ul className="space-y-2 text-xs text-slate-600 border-t border-slate-200/50 pt-4">
                      <li className="flex items-center gap-2">
                        <Check className="w-3.5 h-3.5 text-[#22C55E] shrink-0" />
                        <span>60,000 monthly credits</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Check className="w-3.5 h-3.5 text-[#22C55E] shrink-0" />
                  ...
                  >
                    {plan === "Professional" ? "Current Plan" : "Choose Plan"}
                  </button>
                </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-xs text-slate-600 border-t border-slate-200/50 pt-4">
                      <li className="flex items-center gap-2">
                        <Check className="w-3.5 h-3.5 text-[#22C55E] shrink-0" />
                        <span>Unlimited credit volumes</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Check className="w-3.5 h-3.5 text-[#22C55E] shrink-0" />
              ...
              <div className="p-6 bg-slate-50 border-t border-slate-200 flex justify-between items-center text-xs text-[#64748B]">
                ...
                <button
                  onClick={() => setModalOpen(false)}
                  className="h-8 px-4 text-xs font-semibold hover:bg-slate-100 rounded-lg text-slate-600 transition-colors focus:outline-none"
                >
                  Dismiss
                </button>
              </div>
