  ...
  return (
    <main className="bg-background min-h-screen text-foreground pt-24 pb-16">
      ...
      <section className="max-w-5xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-subtle border border-border/60 rounded-2xl p-6 custom-shadow flex flex-col justify-between">
          <div className="space-y-4">
            <div className="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center">
              <Satellite className="w-5 h-5" />
            </div>
            <h3 className="text-lg font-bold text-foreground">Earth Observation</h3>
        ...
        <div className="bg-subtle border border-border/60 rounded-2xl p-6 custom-shadow flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <h3 className="text-lg font-bold text-foreground">Planetary Scale</h3>
            <p className="text-xs text-slate-550 leading-relaxed">
        ...
        <div className="bg-subtle border border-border/60 rounded-2xl p-6 custom-shadow flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <h3 className="text-lg font-bold text-foreground">Sustainable Yields</h3>
            <p className="text-xs text-slate-550 leading-relaxed">
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 prose prose-slate">
        <h2 className="text-2xl font-extrabold text-foreground mb-4 tracking-tight">Why we built X-AGI</h2>
      ...
      {/* CTA */}
      <section className="max-w-4xl mx-auto px-6 text-center py-12">
        <div className="bg-accent text-white rounded-3xl p-8 md:p-12 shadow-xl relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/register"
              className="bg-background text-accent hover:bg-subtle px-6 py-2.5 rounded-lg text-xs font-bold transition-all custom-shadow text-center"
            >
              Get Free API Key
            </Link>
            <Link
      ...
      {/* Footer social links */}
      <div className="max-w-4xl mx-auto px-6 pt-8 pb-12 border-t border-slate-100 flex justify-center gap-6 text-xs font-semibold text-muted-foreground">
