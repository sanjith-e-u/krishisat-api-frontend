    ...
    <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mt-8 pb-20 px-6 font-sans">
      ...
      <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-28">
        <div>
          ...
          <h1 className="text-3xl font-extrabold text-foreground tracking-tight">Scale crop intelligence dynamically</h1>
        ...
        <div className="space-y-6">
          <div className="flex gap-4">
            ...
            <div>
              <h4 className="text-sm font-bold text-foreground">Enterprise SLA Guarantees</h4>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h4 className="text-sm font-bold text-foreground">Custom Sat-Pipeline Ingress</h4>
              <p className="text-xs text-slate-405 mt-1 leading-relaxed">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h4 className="text-sm font-bold text-foreground">Direct Developer Inquiries</h4>
              <p className="text-xs text-slate-405 mt-1 leading-relaxed">
        ...
        <div className="pt-6 border-t border-slate-100 text-xs text-muted-foreground font-medium select-none">
          Used by agritech teams, precision farming operators, and farm management platforms
        </div>
      </div>

      {/* Right Column: Contact Form */}
      <div className="lg:col-span-7 bg-card border border-border/80 rounded-2xl p-8 custom-shadow">
        {submitted ? (
          <div className="text-center py-12 px-4 space-y-4 font-sans">
            ...
            <div className="pt-6 select-none">
              <button
                ...
                className="bg-primary hover:bg-[#114524] text-white px-5 py-2.5 text-xs font-bold rounded-lg transition-colors custom-shadow cursor-pointer"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <h3 className="text-lg font-bold text-foreground">Corporate System Architecture Inquiry</h3>
              <p className="text-xs text-muted-foreground mt-1 select-none">Fill out the form below and an engineer will review your request.</p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="flex flex-col gap-1.5">
                <label htmlFor="fullname" className="text-xs font-semibold text-muted-foreground select-none">Contact Name</label>
                <input
                  id="fullname"
                  type="text"
                  required
                  ...
                  className={`w-full h-10 px-3 text-sm bg-background border ${
                    nameError ? "border-red-500 focus:ring-red-500/10 focus:border-red-500" : "border-border focus:ring-primary/10 focus:border-primary"
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="email" className="text-xs font-semibold text-muted-foreground select-none">Work Email</label>
                <input
                  id="email"
                  type="email"
                  required
                  ...
                  className={`w-full h-10 px-3 text-sm bg-background border ${
                    emailError ? "border-red-500 focus:ring-red-500/10 focus:border-red-500" : "border-border focus:ring-primary/10 focus:border-primary"
                  } rounded-lg focus:outline-none focus:ring-2 transition-all`}
                />
                {emailError && (
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="company" className="text-xs font-semibold text-muted-foreground select-none">Company Name</label>
                <input
                  id="company"
                  type="text"
                  required
                  ...
                  className="w-full h-10 px-3 text-sm bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/10 focus:border-primary transition-all"
                />
              </div>

              <div className="flex flex-col gap-1.5">
                <label htmlFor="interest" className="text-xs font-semibold text-muted-foreground select-none">Primary API Interest</label>
                <select
                  id="interest"
              ...
              <div className="flex flex-col gap-1.5 sm:col-span-2">
                <label htmlFor="message" className="text-xs font-semibold text-muted-foreground select-none">Describe your coverage area or use case</label>
                <textarea
                  id="message"
                  required
                  rows={4}
                  ...
                  className="w-full p-3 text-sm bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/10 focus:border-primary transition-all resize-none font-sans"
                />
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-border flex flex-col items-end gap-3">
              <button
                type="submit"
                disabled={loading}
                className="h-10 bg-primary hover:bg-[#114524] disabled:bg-primary/70 text-white px-5 rounded-lg text-xs font-bold transition-all custom-shadow focus:outline-none flex items-center gap-1.5 cursor-pointer select-none"
              >
                {loading ? (
              ...
              <p className="text-[11px] text-muted-foreground text-right leading-normal select-none">
