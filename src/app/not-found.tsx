...
export default function NotFound() {
  return (
    <main className="min-h-screen bg-[#0F172A] flex flex-col justify-center items-center px-6 relative overflow-hidden text-white select-none">
      ...
      <div className="z-10 text-center max-w-md flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full justify-center pt-2">
          <Link
            href="/"
            className="bg-[#22C55E] hover:bg-[#1cbd53] text-white px-5 py-2.5 rounded-lg text-xs font-bold transition-colors shadow-sm text-center"
          >
            Go Home
          </Link>
          <Link
