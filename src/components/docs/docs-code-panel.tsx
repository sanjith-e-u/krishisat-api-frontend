        ...
        <div className="space-y-3">
          ...
          >
            <pre
              ...
              className="bg-slate-950/40 p-4 text-[11px] font-mono leading-relaxed overflow-x-auto text-left whitespace-pre text-slate-300 border border-slate-850 rounded-b-lg max-h-[300px] focus:outline-none focus:ring-1 focus:ring-[#14532D] focus:ring-offset-1 focus:ring-offset-slate-950"
            >
