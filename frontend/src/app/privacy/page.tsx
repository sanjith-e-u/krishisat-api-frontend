...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto mt-8 pb-20 px-6 font-sans">
      ...
      <h1 className="text-3xl font-extrabold text-foreground mt-4 tracking-tight">Privacy Policy</h1>
      <p className="text-xs text-muted-foreground mt-2 font-mono">Last updated: June 12, 2026</p>
      ...
      <div className="mt-8 prose prose-slate max-w-none text-slate-650 text-sm leading-relaxed space-y-6">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-foreground">2. Satellite & Crop Telemetry Data</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-foreground">3. Cookies and Usage Analytics</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-foreground">6. Developer Rights & Access</h2>
          <p>
